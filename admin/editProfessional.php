...
echo $obj->footer();
$detail =  $obj1->professionalDetail($_GET['id']);
if(isset($_REQUEST['submit'])){
    $add = $obj1->editProfessional($_POST,$_GET['id']);
    if($add == 1){?>
                            ...
                            <form class="form-horizontal" method="post" action="" id="proForm">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <?php echo $obj1->professionalRemain($detail["prof_id"]);?>
                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                             <input type="text" class="form-control" name="professional" id="professional" value="<?php echo $detail["professional"];?>">  
                                            </div>
...
<script type="text/javascript">
   ...
   $('#proForm').on("submit",function(e){
    ...
    if(professional=="")
    {
        ...
        $("#proMsgedit").html("Please enter Professional.");
