	...
	break;
	  ...
	  if($delete){
	    ...
	    break;
	     case 'delCategory':
	  $id = $_POST['id'];
	  $delete = $con->query("Delete from `category` where id='".$id."'");
	  if($delete){
	  	echo 'success';exit;
        }else{
	  	echo 'error';exit;
	  ...
	  break;
	     case 'delEducation':
	  $id = $_POST['id'];
	  $delete = $con->query("Delete from `tbl_education` where id='".$id."'");
	  if($delete){
	  	echo 'success';exit;
        }else{
	  	echo 'error';exit;
	  ...
	  break;
	     case 'delProfessional':
	  $id = $_POST['id'];
	  $delete = $con->query("Delete from `tbl_professional` where id='".$id."'");
	  if($delete){
	  	echo 'success';exit;
        }else{
	  	echo 'error';exit;
	  ...
	  break;
	     case 'delProfession':
	  $id = $_POST['id'];
	  $delete = $con->query("Delete from `tbl_profession` where id='".$id."'");
	  if($delete){
	  	echo 'success';exit;
        }else{
	  	echo 'error';exit;
